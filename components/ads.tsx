...
export function NativeBannerAd() {
  ...
  return (
    <div className="my-6 flex justify-center w-full overflow-hidden min-h-[100px]">
      <div id="container-49cea55cbb8438714863d6ebac757595" className="w-full"></div>
      <script async="async" data-cfasync="false" src="https://pl30120015.effectivecpmnetwork.com/49cea55cbb8438714863d6ebac757595/invoke.js"></script>
    </div>
  )
}

              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {guide.domains.slice(0, 6).map((domain, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-2 text-sm text-muted-foreground bg-gray-50 p-2 rounded-md"
                    >
            ...
            <div className="bg-white/70 p-4 rounded-lg border border-red-100">
              ...
              <ol className="space-y-2 text-sm">
                ...
                {guide.difficulty === "medium" && (
                  <li className="flex items-start gap-2">
                    <span className="bg-orange-600 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold mt-0.5">
                      !
                    </span>
                ...
                {guide.difficulty === "limited-availability" && (
                  <li className="flex items-start gap-2">
                    <span className="bg-purple-600 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold mt-0.5">
                      !
                    </span>
                ...
                {guide.difficulty === "impossible" && (
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-zinc-900 font-semibold">{t("alert-impossible-desc")}</span>
                  </li>
                )}
              </ol>
            </div>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="bg-slate-100 p-3 rounded-lg">
                <p className="text-sm text-slate-700">{t("timeline-note")}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-12">
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t("reco-category-desc", { category: guide.category })}</CardDescription>
            </CardHeader>
            <CardContent>
